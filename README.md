...
- Optimize for deleteability. If something is not used, it can be deleted from the project.

- rm -rf .cache dist/ - It clears ou t all the build files for parcel and resets the memory (if things aren't working)
